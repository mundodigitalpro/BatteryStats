...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        batteryStatus?.let { intent ->
            ...
            val batteryLow: Boolean = intent.getBooleanExtra(BatteryManager.EXTRA_BATTERY_LOW, false)
            val batteryPresent: Boolean = intent.getBooleanExtra(BatteryManager.EXTRA_PRESENT, false)
            ...
            binding.batteryLowInfo.text = "Battery Low: $batteryLow"
            binding.batteryPresentInfo.text = "Battery Present: $batteryPresent"
            binding.powerSaveModeInfo.text = "Power Save Mode: $isPowerSaveMode"
